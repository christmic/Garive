...
/// OS credential-store service reserved for creativity publication.
pub const CREATIVITY_CREDENTIAL_SERVICE: &str = "com.garive.creativity";
...
impl CredentialReferenceResolver for SystemCredentialReferenceResolver {
    fn resolve(&self, credential_ref: &str) -> Result<SecretValue, CredentialResolutionFailure> {
        let entry = keyring::Entry::new(CREATIVITY_CREDENTIAL_SERVICE, credential_ref)
