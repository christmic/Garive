...
| PL1 | Durable executable Plan | accepted | accepted | documented | partial | partial | active | Rust/Kotlin canonical DAG/reducer and 15 strict L0 facts are green. SQLite normal-path proposal/adoption/claim/start/completion, monotonic expiry, restart reconstruction, competing claims and exact replay pass; atomic creation of the bound C6 Execution/effect posture, carry-forward and client projection remain. |
