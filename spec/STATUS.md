...
| A-TUI | Resident terminal product | accepted | accepted | documented | implemented | partial | active | Keep the verified macOS and Linux arm64 Runtime/SQLite/PTTY, reducer, editor, render, persistence, H2/H3 navigation and activity flows plus Windows/Linux x86_64 all-target check and strict-Clippy evidence green; Windows native ACL/ConPTY, Linux x86_64 native/physical-terminal/tmux/`TERM=dumb`, scheduled churn, and final screenshot closure remain open. |
