...
| T1 Built-in tools | accepted | accepted | partial | partial | partial | active | Rust/Kotlin exact catalogue, schemas, resolvers and shared Prepared-v3 digest/access fixture are verified. Implement confined read/list/search, journaled patch and sandboxed process Runtime executors next. |
