...
| Memory M1 | accepted | accepted | documented | partial | partial | active | M1-A registry/classification/authority/import is shared and verified; implement M1-B lifecycle/tally reducer next. |
