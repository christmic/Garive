...
| F0 | Sandbox enforcement and safety governance | accepted | accepted | documented | partial | partial | active | Rust/Kotlin profiles and Prepared-v3 bindings plus Runtime deny/stale-policy/scope/enforcement preflight are green; durable effect facts/recovery and concrete native sandbox executors remain. |
...
| PL1 | Durable executable Plan | accepted | accepted | documented | partial | partial | active | Rust/Kotlin canonical DAG/reducer and 15 strict L0 facts are green. SQLite proposal/adoption/claim/terminal paths, monotonic expiry, restart, competing claims, exact replay and bounded retry pass. Step Start now atomically creates its bound C6 Turn/Execution and recovery verifies one SQLite commit version; the unbound Start path is closed. Durable F0 effect posture, carry-forward and client projection remain. |
