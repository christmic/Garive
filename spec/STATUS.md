...
| P2-VX-ATC | Anthropic exact input-token count | accepted | accepted | missing | missing | missing | active | Implement the exact create-request projection, explicit vendor profile and strict response in Rust/Kotlin; then connect a bounded live evidence command. |
