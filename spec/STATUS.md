...
| Memory M2 | accepted | accepted | missing | missing | missing | active | Deliver M2-A through M2-D: bounded canonical Markdown snapshots, Rust/Kotlin import plans, atomic SQLite control receipts, then a redacted Host/Desktop review flow. |
