...
| Memory M1 | accepted | accepted | documented | partial | partial | active | M1-A through M1-F are verified: shared Rust/Kotlin semantics, exact L0 maintenance/privacy facts, indivisible user forget, SQLite restart projection and torn-prefix rejection; implement M1-G derive integration and pinned quality evaluation next. |
