...
| C7-A | Context-pressure baseline evidence | accepted | accepted | documented | missing | missing | active | Implement strict corpus, explicit token-counter port, pure reduction and non-publishable E2E evidence. |
