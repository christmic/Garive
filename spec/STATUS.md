...
| A-DESKTOP-C2 | Secure Desktop configuration onboarding | accepted | accepted | partial | partial | partial | active | Complete expiry/idempotency, cancellation, exact setup state/catalogue, shared crash fixtures and first-run/reconfigure UI; strict v2, redacted planning, credential commit and staged recovery are implemented. |
