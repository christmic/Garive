...
| C7-B | Exact provider counter composition | accepted | accepted | missing | missing | missing | active | Compose Core assembly, P2-C Messages mapping and P2-VX-ATC behind a secret-safe injected exchange port; verify every C7-A class without claiming a live publication run. |
