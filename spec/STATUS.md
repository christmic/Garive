...
| Memory M2 | accepted | accepted | missing | partial | partial | active | Migrate the initial Rust document parser/tests from alias numeric revisions to exact M0 record/revision identities, then deliver the Kotlin plan, SQLite receipts and Host/Desktop flow. |
