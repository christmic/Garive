...
| Memory M1 | accepted | accepted | documented | partial | partial | active | M1-A through M1-E plus M1-F1 four-decision admission, distillation watermark, and deterministic audit are verified in Rust/Kotlin; implement M1-F2 promotion/forget/erasure receipts next. |
