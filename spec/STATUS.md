...
| Memory M1 | accepted | accepted | documented | partial | partial | active | M1-A/M1-B classification and exact lifecycle/tally reducers are shared and verified; implement M1-C bounded menu/detail selection next. |
