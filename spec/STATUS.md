...
| A-TUI | Resident terminal product | accepted | accepted | documented | implemented | partial | active | Keep the verified macOS Runtime/PTY, reducer, editor, render, persistence, H2/H3 navigation and activity flows plus Windows/Linux all-target check and strict-Clippy evidence green; Windows native ACL/ConPTY, Linux native execution/PTY, scheduled churn, and final screenshot closure remain open. |
