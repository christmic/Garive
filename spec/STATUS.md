...
| PL1 | Durable executable Plan | accepted | accepted | documented | partial | partial | active | Rust/Kotlin canonical DAG, scope/coverage validation, readiness, claims and attempt bounds share one green fixture; L0 facts, leases, recovery and C6/F0 binding remain. |
