...
| A-DESKTOP-C2 | Secure Desktop configuration onboarding | accepted | accepted | partial | partial | partial | active | Complete durable recovery journal, expiry/idempotency, credential rotation cleanup and shared fixtures; strict v2, redacted planning, Keychain commit, restart IPC and three-step first-run UI are implemented. |
