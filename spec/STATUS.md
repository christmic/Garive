...
| A-DESKTOP-WORK | macOS local-first work product | accepted | accepted | partial | partial | partial | active | Complete shared H3 evidence, crash/accessibility matrices and signed packaged macOS gates; H1/H2/C2 sessions, continuation, setup, deliverables, exact committed Activity/approval detail, selected-file context UX, native bookmark recovery and governed Artifacts are implemented. |
