...
| A-TUI | Resident terminal product | accepted | accepted | documented | implemented | partial | active | Keep the verified macOS Runtime/PTY, reducer, editor, render, persistence, H2/H3 navigation and activity flows plus Windows all-target check/strict-Clippy evidence green; Windows native ACL/ConPTY, Linux native build/PTY, scheduled churn, and final screenshot closure remain open. |
