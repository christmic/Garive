...
| A-DESKTOP-C2 | Secure Desktop configuration onboarding | accepted | accepted | partial | partial | partial | active | Complete exact setup state/catalogue, shared crash fixtures and first-run/reconfigure UI; strict v2, redacted expiring/idempotent planning, cancellation, credential commit and staged recovery are implemented. |
