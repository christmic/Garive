...
| A-DESKTOP-WORK | macOS local-first work product | accepted | accepted | partial | partial | partial | active | Complete shared H3 evidence, VoiceOver/200%-zoom/localization matrices and Developer-ID/notarized release gates. H1/H2/C2 sessions, exact Activity/approval detail, Workspaces and governed Artifacts are implemented; bounded strict-cursor pagination restores up to 512 Turns/256 Artifacts without silently dropping later work. Native Garive/File/Edit/View/Window menus route four closed data-free intents through the same React state machine. Strict bounded appearance preferences support live System/Light/Dark theme selection and Comfortable/Compact density without persisting sensitive state. Picker focus containment/restoration, semantic Inspector tabs and system accessibility preferences have local evidence. A hardened-runtime Universal ad-hoc DMG passes local audit, while Gatekeeper, stapling and warning-free strip remain external release gates. |
...
| A-UX1 | Product client experience | accepted | accepted | partial | partial | partial | active | Close shared Web/native controller and remaining localization/accessibility evidence. Desktop now includes H3 activity and exact approvals, typed continuation, complete bounded history restoration, native menu/shortcut parity, governed Artifact preview/export, distinct pending/committed Workspace context, durable detach/revoke, focus-contained native selection, explicit path-free recovery actions, and schema-closed theme/density preferences. |
