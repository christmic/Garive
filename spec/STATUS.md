...
| A-DESKTOP-WA | Governed Workspaces and artifacts | accepted | accepted | documented | missing | missing | active | Implement native bookmark-backed grants, Session attachment, governed file tools, immutable artifact projection, safe preview/export and the crash/accessibility matrices. |
