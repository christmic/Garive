...
| A-MOBILE-R | Native remote-work mobile product | accepted | accepted | documented | missing | missing | active | Implement authenticated HTTPS KMP transport/controller and polished Compose/SwiftUI surfaces, then close with physical iOS/Android Gateway-to-Runtime create/reconnect/decision/cancel/revoke evidence. |
