...
| Memory M1 | accepted | accepted | documented | missing | missing | active | Implement M1-A through M1-G without weakening M0 durability, authority, or replay guarantees. |
