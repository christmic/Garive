...
| Memory M1 | accepted | accepted | documented | partial | partial | active | M1-A through M1-C classification, lifecycle and replayable bounded recall are shared and verified; implement M1-D observation/attribution next. |
