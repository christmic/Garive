...
fn navigate_definition(
    ...
    definition(
        ...
        json!({"type":"object","properties":{"session_id":{"type":"string","minLength":1,"maxLength":128},"page_id":{"type":"string","minLength":1,"maxLength":128},"expected_snapshot_id":{"type":"string","minLength":1,"maxLength":128},"destination_url":{"type":"string","minLength":1,"maxLength":8192},"destination_origin":{"type":"string","minLength":10,"maxLength":512},"wait_until":{"type":"string","enum":["dom_content_loaded","load","network_idle"]},"timeout_ms":{"type":"integer","minimum":1,"maximum":120000},"max_nodes":{"type":"integer","minimum":1,"maximum":10000},"max_text_bytes":{"type":"integer","minimum":1,"maximum":1048576}},"required":["session_id","page_id","expected_snapshot_id","destination_url","destination_origin","wait_until","timeout_ms","max_nodes","max_text_bytes"],"additionalProperties":false}),
        [
