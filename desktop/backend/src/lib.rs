...
pub use setup::{
    ...
    DesktopSetupReceipt, DesktopSetupService, DesktopSetupState, DesktopSetupSummary, SetupClock,
    SetupCredentialStore, SystemSetupClock, SystemSetupCredentialStore,
};
