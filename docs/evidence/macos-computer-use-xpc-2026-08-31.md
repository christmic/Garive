...
Latest result: 20 Swift Testing tests passed, including four permission-posture
...
user/session mismatch and invalid requirements. No permission prompt, screen
capture, input dispatch, environment read, or Engine/Ledger access occurs.
...
live permission-granted AX fixture coverage,
