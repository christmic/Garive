...
界面流程（16 条加 4 条 opt-in 真实 Host journeys，含严格配对链接、整应用 Work → Sessions →
...
create/start → cancel → append、批准/拒绝提交、Sessions 搜索/状态筛选、系统分享 sheet 与 Light → Dark → System 切换）与构建，以及断开/恢复 Host 的
