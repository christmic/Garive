...
import com.garive.runtime.server.ledger.CommitResult
import com.garive.runtime.server.ledger.DurableFact
...
class PostgresLedger private constructor(private val config: PostgresConfig) {
    ...
    private fun <T> readState(block: (com.garive.runtime.server.ledger.LedgerState) -> T): T =
