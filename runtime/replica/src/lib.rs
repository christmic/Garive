...
pub use core_bridge::{
    ...
    reconstruct_memory_maintenance_projection, reconstruct_memory_state, verify_memory_evidence,
    ...
    PlannedKnowledgeCompletion, PlannedMemoryForget, PlannedMemoryObservation,
    PlannedMemoryPromotion, PlannedMemoryRecall, PlannedMemoryRetrieval, PlannedMemoryTombstone,
    ...
    RecordedMemoryDecision, RecordedMemoryErasure, RecordedMemoryRecall,
