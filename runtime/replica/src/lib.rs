...
pub use core_bridge::{
    ...
    plan_knowledge_requested, plan_memory_obligation, plan_memory_observation, plan_memory_recall,
    ...
    reconstruct_memory_hypothesis_projection, reconstruct_memory_state, verify_memory_evidence,
    ...
    MemoryAccessGrant, MemoryHypothesisProjection, MemoryObligationContext,
    ...
    PlannedMemoryObservation, PlannedMemoryRecall, PlannedMemoryRetrieval, PlannedMemoryTombstone,
