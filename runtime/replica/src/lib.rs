...
pub use core_bridge::{
    ...
    execute_durable_model_only_with_skill_activation, plan_classified_memory_write,
    ...
    reconstruct_memory_maintenance_projection, reconstruct_memory_repository_projection,
