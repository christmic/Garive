...
pub use core_bridge::{
    ...
    plan_schedule_fired, plan_schedule_skipped, plan_skill_activation, reconstruct_memory_state,
    verify_memory_evidence, AuthorityDecision, AuthorityFuture, AuthorityPort, AuthorityRequest,
    ...
    ModelLifecycleContext, PlannedKnowledgeCompletion, PlannedMemoryRetrieval,
