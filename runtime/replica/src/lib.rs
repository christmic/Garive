...
pub use core_bridge::{
    ...
    PlannedMemoryArchive, PlannedMemoryForget, PlannedMemoryObservation, PlannedMemoryPromotion,
    PlannedMemoryRecall, PlannedMemoryRetrieval, PlannedMemoryTombstone, PlannedMemoryWrite,
