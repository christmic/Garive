...
pub use core_bridge::{
    ...
    plan_model_terminal, plan_model_uncertain, CoreTerminalContext, DurableExecutionConfig,
    DurableExecutionError, DurableExecutionResult, ModelLifecycleContext, PreparedModelRequest,
    RuntimeModelUncertainReason, TerminalPublicationError, TerminalPublisher,
};
